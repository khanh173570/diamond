    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.value}>
          <Text style={styles.id} >{commitmentResult.committedId}</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.text}>
            ...
            <Text style={styles.value}>{formattedDate(commitmentResult.committedDate)}</Text>
          </View>
          <View style={styles.text}>
        ...
        <View style={styles.policy}>
          <View style={styles.section}>
            ...
            <Text style={styles.text}>
              ...
              reported immediately at the transaction counter. Once leaving the
              counter, customers cannot request resolution of any complaints
